...
const char* product_str(ushort product){
    ...
    if(product == P_NIGHTSWORD)
        return "nightsword";
    if(product == P_IRONCLAW_W_U || product == P_IRONCLAW_W_D || product == P_IRONCLAW_W_SE_U || product == P_HARPOON_WL_U || product == P_HARPOON_WL_D)
